...
```
```
  0-1250m  N=179  avg_rays ON=32115.7 OFF=77.6  [2853s]
  Method            N    Bias     MSE   RMSE    STD      R2  (ON | OFF)
  ON  incoh       179   -10.7   289.6   17.0   13.2   0.111
  OFF incoh       179    -9.7   295.1   17.2   14.2   0.095
  ON  coh         179   -25.1   698.4   26.4    8.3  -1.143
  OFF coh         179    -9.2   294.7   17.2   14.5   0.096
  ON  best        179    -6.7   300.3   17.3   16.0   0.079
  OFF best        179    -7.6   275.8   16.6   14.8   0.154
```
*(0–1500m through 0–4000m bands — pending, run still in progress)*
...
| 0–1250m | 179 | 14.2 dB | **17.0 dB** | **+2.8** | +0.378 | **+0.111** | 10.6 | **13.2** |
