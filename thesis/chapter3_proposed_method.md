...
*Table 3.2 — Full calibrated material set (Nottingham 2695 MHz, Run 3), reused as the initial parameter set for other frequencies at the same site. Six of these materials are held fixed (itu_ceiling_board, itu_asphalt (not shown, locked), itu_metal, canopy/trunk) while the remainder are free parameters in the Powell calibration (Section 3.4).*
...
**4. Calibration (Powell optimisation, three phases).**
